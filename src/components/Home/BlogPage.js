...
export const blogData = [
  {
    img: 'https://motoringworld.in/wp-content/uploads/2024/06/fronx-velocity.jpg',
    ref: "https://zeenews.india.com/auto/maruti-fronx-velocity-edition-now-available-across-all-variants-check-prices-2759468.html",
    title:
      "Maruti Fronx Velocity Edition Now Available Across All Variants, Check Prices",
    subTitle:
      "Maruti Fronx: Initially, velocity edition was made available with the Turbo powertrain only and now the company has decided to introduce it across all variants.",
    publishedBy: "zeeNews",
    date: "21 June 2024",
    desc: `Maruti Fronx Velocity Edition: Maruti Suzuki has expanded its Fronx velocity edition across the SUV's all 14 variants comprising 1.2L (Petrol and CNG) and 1.0L powertrain options with a choice of manual and automatic transmissions. Initially, the velocity edition was made available with the Turbo powertrain only and now the company has decided to introduce it across all variants.   
    `,
    desc2: `The Fronx 1.2L velocity edition sigma variant is priced at Rs 7.29 lakh (ex-showroom) for a limited period, almost Rs 22000 more affordable than the regular Sigma variant (Rs 7.51 Lakh). The Velocity Edition elevates Fronx's dynamic and aesthetic appeal with a suite of exclusive accessory upgrades.  `,
    desc3: `Speaking on this occasion, Partho Banerjee, Senior Executive Officer, Marketing & Sales at Maruti Suzuki India Limited, said, “FRONX has carved a niche, captivating customers who seek a bold SUV experience. Achieving 100,000 sales in just ten months is a testament to customers' love for this innovatively designed and sporty compact SUV."`,
    desc4: `"By offering the Velocity Edition across all variants of FRONX, we are not just celebrating this success; we are reaffirming our commitment to providing our customers with a wide array of choices, making FRONX an even more compelling option for our discerning customers", he said.`,
    desc5: `Powertrain`,
    desc6: `The Fronx is offered with two powertrain options. Performance enthusiasts can opt for the all-new 1.0L K-Series Boosterjet petrol engine with Smart Hybrid technology mated with either a 5-speed manual or a 6-speed automatic transmission. `,
    desc7: `It is also available with a 1.2L K-Series Dual Jet, Dual VVT engine, paired with a 5-speed manual or 5-speed AGS transmission. Additionally, Maruti also offers a CNG option with this 1.2L engine, claiming best-in-class fuel efficiency of 28.51 km/kg.`,
    desc8: `Features`,
    desc9: `It offers a wide range of features such as a Head-Up Display with turn-by-turn navigation, a wireless smartphone charger, 360 View Camera, and a 9-inch infotainment system with wireless Apple CarPlay and Android Auto connectivity, to name a few.`
  },
  {
    img: 'https://motoringworld.in/wp-content/uploads/2024/06/fronx-velocity.jpg',
    ref: "https://motoringworld.in/car-news/maruti-suzuki-fronx-velocity-edition-launched/",
    title:
      "Maruti Suzuki Fronx Velocity Edition now available in all variants",
    subTitle:
      "The Fronx Velocity Edition continues with the 1.2-litre and 1.0-litre powertrains",
    publishedBy: "Motoring",
    date: "21 June 2024",
    desc: `The Fronx has been an interesting product for Maruti Suzuki, having sold about 1 lakh units in just ten months. It’s also Maruti’s second weapon in the compact SUV segment after the Brezza. Now, Maruti Suzuki has made the Velocity Edition of the Fronx, available across all variants, and it can be had from Rs 7.29 lakh onwards (ex-showroom). `,
    desc2: `Now relax; you won’t have to be familiar with physics lessons to buy the Fronx Velocity Edition though, and what is it exactly, anyway? This particular car gets only cosmetic accessories added, which means there’s garnishes for the headlamps, wheel arches, and the grille, along with body mouldings with black and red inserts, illuminated sill guards, door visors, a 3D boot mat, and carbon fibre interior elements.`,

  },
  {
    img: require("../../assets/HomePageImages/MARUTI_SUZUKI_NEXA_JIMNY_THUNDER_EDITION.webp"),
    ref: "https://www.cardekho.com/india-car-news/maruti-jimny-thunder-edition-launched-brings-down-the-starting-price-to-rs-1074-lakh-31763.html",
    title:
      "Maruti Jimny Thunder Edition Launched, Brings Down The Starting Price To Rs 10.74 Lakh",
    subTitle:
      "With the new limited edition, the Maruti Jimny has become more affordable by up to Rs 2 lakh",
    publishedBy: "CarDekho",
    date: "04 Dec 2023",
    desc: `Maruti launched the 5-door Jimny in June 2023, offering it in two well-equipped variants.
    The new limited edition comes with accessory items as door visor, interior styling kit and a tan-finish steering wheel.
    No feature changes made to the Jimny; still gets 9-inch touchscreen and 6 airbags.
    
    Gets the existing model’s 1.5-litre petrol engine with 4WD as standard.
    Revised prices range from Rs 10.74 lakh to Rs 14.05 lakh (ex-showroom Delhi).
    
    The 5-door Maruti Jimny went on sale in June 2023, with prices starting at Rs 12.74 lakh. Now, it has received a significant price cut of up to Rs 2 lakh, for a limited period, with the introduction of the ‘Thunder Edition.’ Here’s a look at its revised prices and what the limited edition has to offer:`,
  },
  {
...
const BlogPage = ({ selected, setSelected }) => {
  return (
    <>
      <Header col={true} />
      <div className="pb-[67px]  sm:pb-[120px] lg:pb-[135px]"></div>
      <div className="container p-4 px-2 pb-6 mx-auto lg:px-0 ">
        <div className="pt-2 pb-4 text-5xl font-medium text-red-600 uppercase lg:pt-3 md:text-center">
        ...
        <div className="grid grid-cols-1 gap-4 lg:grid-cols-3 ">
          <div className="col-span-1 lg:col-span-2">
            ...
            <div className="justify-between md:flex lg:gap-4">
              <div className="my-2 rounded md:my-4 w-min whitespace-nowrap">
            ...
            <img
              ...
              className="object-cover overflow-hidden bg-black shadow-lg rounded-2xl shadow-gray-500 saturate-200"
            />
            <div className="my-4 text-justify lg:text-lg">
              <p className="mb-2 indent-8">{blogData[selected].desc}</p>
              <p className="mb-2">{blogData[selected].desc2}</p>
              <p className="mb-2">{blogData[selected].desc3}</p>
              <p className="mb-2">{blogData[selected].desc4}</p>
              <p className="mb-2">{blogData[selected].desc5}</p>
              <p className="mb-2">{blogData[selected].desc6}</p>
              <p className="mb-2">{blogData[selected].desc7}</p>
              <p className="mb-2">{blogData[selected].desc8}</p>
              <p className="mb-2">{blogData[selected].desc9}</p>

            </div>
            <div className="my-4 italic lg:text-lg">
              News link: <br className="md:hidden" />
              <a
                href={blogData[selected].ref}
                target="_blank"
                rel="noreferrer"
                aria-label={blogData[selected].title}
          ...
          <div className="col-span-1 px-2 pb-2 overflow-x-hidden lg:max-h-screen">
            ...
            {blogData.map((x, i) => (
              <div
                ...
                className={`flex flex-row gap-4 py-1 border-b cursor-pointer lg:px-2  ${i === selected ? "bg-gray-100 rounded-lg shadow-gray-500 shadow-lg" : " group hover:rounded-lg shadow-gray-500 hover:shadow-lg"}`}
                onClick={() => setSelected(i)}
              >
                <img
                  src={x.img}
                  alt={x.title}
                  className="h-24 overflow-hidden duration-500 rounded-lg brightness-110 lg:h-auto lg:w-1/3 group-hover:scale-95"
                />

                <div className="flex flex-col justify-around w-2/3 gap-4 duration-500 group-hover:scale-105">
                  <div>
                    ...
                    <div className="flex justify-between">
                      ...
                      <div className="pb-2 text-sm text-gray-600">{x.date}</div>
                    </div>
                  </div>
                </div>
              </div>
